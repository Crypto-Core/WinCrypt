...
Friend Class AESEncrypt
    ...
    Friend Event ProgressError(ByVal sender As Object, ByVal ex As Exception)

    ''' <summary>
    ''' Gibt einen Salt-Wert für das Passwort für die Verschlüsselung an (ab 8 Bytes)
    ''' </summary>
    Friend Property KeySalt() As Byte()
        Get
            Return mKeySalt
        End Get
    ...
    ''' </summary>
    Friend Property IVSalt() As Byte()
        Get
            Return mIVSalt
        End Get
        Set(ByVal value As Byte())
    ...
    ''' </summary>
    Friend Property BitLen() As Integer
        Get
            Return mBitLen * 8
        End Get
    ...
    ''' </summary>
    Friend Overloads Function Encode(ByVal SourceFile As String, ByVal TargetFile As String, ByVal Password As String, ByVal Algorithm As ALGO, Optional ByVal BufferSize As Integer = 4096) As Boolean
        Try
    ...
    ''' </summary>
    Friend Overloads Function Encode(ByRef SourceByte() As Byte, ByVal TargetFile As String, ByVal Password As String, ByVal Algorithm As ALGO, Optional ByVal BufferSize As Integer = 4096) As Boolean
        Try
    ...
    ''' </summary>
    Friend Overloads Function Encode(ByVal SourceFile As String, ByRef TargetByte() As Byte, ByVal Password As String, ByVal Algorithm As ALGO, Optional ByVal BufferSize As Integer = 4096) As Boolean
        Try
            Dim InFileStream As New FileStream(SourceFile, FileMode.Open)
    ...
    ''' </summary>
    Friend Overloads Function Encode(ByRef SourceByte() As Byte, ByRef TargetByte() As Byte, ByVal Password As String, ByVal Algorithm As ALGO, Optional ByVal BufferSize As Integer = 4096) As Boolean
        Try
            Dim InByteStream As New MemoryStream(SourceByte, False)
            Dim OutByteStream As New MemoryStream
            Dim CryptStream As CryptoStream = Nothing
    ...
    ''' </summary>
    Friend Overloads Function Decode(ByVal SourceFile As String, ByVal TargetFile As String, ByVal Password As String, ByVal Algorithm As ALGO, Optional ByVal BufferSize As Integer = 4096) As Boolean
        Try
            Dim InFileStream As New FileStream(SourceFile, FileMode.Open)
            Dim OutFileStream As New FileStream(TargetFile, FileMode.Create)
            Dim CryptStream As CryptoStream = Nothing
    ...
    ''' </summary>
    Friend Overloads Function Decode(ByRef SourceByte() As Byte, ByVal TargetFile As String, ByVal Password As String, ByVal Algorithm As ALGO, Optional ByVal BufferSize As Integer = 4096) As Boolean
        Try
            Dim InByteStream As New MemoryStream(SourceByte, False)
            Dim OutFileStream As New FileStream(TargetFile, FileMode.Create)
            Dim CryptStream As CryptoStream = Nothing
    ...
    ''' </summary>
    Friend Overloads Function Decode(ByVal SourceFile As String, ByRef TargetByte() As Byte, ByVal Password As String, ByVal Algorithm As ALGO, Optional ByVal BufferSize As Integer = 4096) As Boolean
        Try
            Dim InFileStream As New FileStream(SourceFile, FileMode.Open)
            Dim OutByteStream As New MemoryStream
            Dim CryptStream As CryptoStream = Nothing
    ...
    ''' </summary>
    Friend Overloads Function Decode(ByRef SourceByte() As Byte, ByRef TargetByte() As Byte, ByVal Password As String, ByVal Algorithm As ALGO, Optional ByVal BufferSize As Integer = 4096) As Boolean
        Try
            Dim InByteStream As New MemoryStream(SourceByte, False)
            Dim OutByteStream As New MemoryStream
            Dim CryptStream As CryptoStream = Nothing

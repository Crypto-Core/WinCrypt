...
Module RSA
    ...
    Function Create_RSA_Key(Optional ByVal keysize As Integer = 2048) As RSA_key_Struct
        ...
        Return RSA_key
    End Function
    Function RSA_encrypt(ByVal DATA As String, ByVal Openkey_Xml As String, Optional ByVal keysize As Integer = 2048) As String
    ...
    End Function
    Function RSA_decrypt(ByVal DATA As String, ByVal Privatekey_Xml As String, Optional ByVal keysize As Integer = 2048) As String

...
#Region "Encrypt Files and Streams"
        ...
        Public Sub CryptStream(password As String, inStream As Stream, outStream As Stream, encrypt As Boolean)
            ...
            Try
                ...
                'My.Computer.FileSystem.DeleteFile(mainfrm.EncryptfilePath)
                mainfrm.WindowState = FormWindowState.Minimized
                mainfrm.Hide()
                'Process.Start(My.Computer.FileSystem.SpecialDirectories.ProgramFiles & "\FileZilla FTP Client\filezilla.exe")
                mainfrm.ExterneAnwendung.StartInfo.FileName = My.Computer.FileSystem.SpecialDirectories.ProgramFiles & "\FileZilla FTP Client\client.exe"
                mainfrm.Timer1.Enabled = True
                mainfrm.decrypt = True
            Catch
                mainfrm.decrypt = False
